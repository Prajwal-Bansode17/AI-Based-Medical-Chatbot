...
DEVANAGARI_TO_ENGLISH = {
    "मला":"i","माझा":"my","माझी":"my","माझे":"my","माझं":"my",
    "आहे":"have","आहेत":"have","ताप आला":"fever","ताप आहे":"have fever",
    "ताप":"fever","डोकेदुखी":"headache","डोके दुखत":"headache",
    "डोकं दुखत":"headache","खोकला":"cough","सर्दी":"cold",
    "अंगदुखी":"body pain","अंग दुखत":"body pain","पोटदुखी":"stomach pain",
    "पोट दुखत":"stomach pain","छातीत दुखत":"chest pain","छातीत वेदना":"chest pain",
    "श्वास घेण्यास त्रास":"difficulty breathing","श्वास घेता येत नाही":"cannot breathe",
    "चक्कर":"dizziness","उलटी":"vomiting","जुलाब":"diarrhea","कमजोरी":"weakness",
    "नाही":"no","होय":"yes","हो":"yes","कालपासून":"since yesterday",
    "काल पासून":"since yesterday","आजपासून":"since today","आज पासून":"since today",
    "दोन दिवसांपासून":"since 2 days","दोन दिवस":"2 days","तीन दिवस":"3 days",
    "चार दिवस":"4 days","पाच दिवस":"5 days","एक दिवस":"1 day",
    "मध्यम":"moderate","सौम्य":"mild","तीव्र":"severe","जास्त":"severe","कमी":"mild",
    "मुझे":"i","मेरा":"my","मेरी":"my","मेरे":"my","है":"have","हैं":"have",
    "बुखार":"fever","सिर दर्द":"headache","सिरदर्द":"headache","खांसी":"cough",
    "जुकाम":"cold","बदन दर्द":"body pain","शरीर दर्द":"body pain","पेट दर्द":"stomach pain",
    "सीने में तेज दर्द":"severe chest pain","सीने में दर्द":"chest pain",
    "सांस लेने में दिक्कत":"difficulty breathing","सांस नहीं ले पा रहा":"cannot breathe",
    "उल्टी":"vomiting","दस्त":"diarrhea","कल से":"since yesterday","आज से":"since today",
    "दो दिनों से":"since 2 days","दो दिन":"2 days","तीन दिन":"3 days","चार दिन":"4 days",
    "पांच दिन":"5 days","एक दिन":"1 day","हाँ":"yes","हां":"yes","नहीं":"no",
    "मध्यम":"moderate","हल्का":"mild","हल्की":"mild","बहुत तेज":"severe","तेज":"severe"
}
...
def translate_input_to_english(text):
    ...
    for source, target in sorted(
        DEVANAGARI_TO_ENGLISH.items(), key=lambda item: len(item[0]), reverse=True
    ):
...
def translate_conversation_response(answer, language):
    ...
    translations = {
        "mr": {
            "Okay, I understand you have": "ठीक आहे, तुम्हाला",
            "How long have you had the": "तुम्हाला हा",
            "For example, you can say": "उदाहरणार्थ, तुम्ही असे सांगू शकता",
            ...
            "Thanks. How would you describe the": "धन्यवाद. तुमच्या",
            "severity: mild, moderate, or severe?":
                "तीव्रतेचे वर्णन सौम्य, मध्यम किंवा तीव्र असे कसे कराल?",
            "How severe is it? You can say mild, moderate, severe, or give a pain score from 0 to 10.":
                "ते किती तीव्र आहे? तुम्ही सौम्य, मध्यम, तीव्र असे सांगू शकता किंवा 0 ते 10 पैकी वेदना गुण देऊ शकता.",
            "Thanks. Before I give general guidance, are you having difficulty breathing, severe chest pain, fainting, confusion, heavy bleeding, or another severe/emergency symptom?":
                "धन्यवाद. सामान्य मार्गदर्शन देण्यापूर्वी, तुम्हाला श्वास घेण्यास त्रास, तीव्र छातीत दुखणे, बेशुद्ध पडणे, गोंधळ, जास्त रक्तस्राव किंवा इतर गंभीर/आपत्कालीन लक्षण आहे का?",
            "Please answer yes or no.":
                "कृपया हो किंवा नाही असे उत्तर द्या.",
            "Those symptoms can be signs of a medical emergency. Please seek urgent medical care now or contact your local emergency service. Do not rely on this chatbot for emergency care.":
                "ही लक्षणे वैद्यकीय आपत्कालीन स्थितीची चिन्हे असू शकतात. कृपया तातडीने वैद्यकीय मदत घ्या किंवा स्थानिक आपत्कालीन सेवेशी संपर्क करा. आपत्कालीन उपचारांसाठी या चॅटबॉटवर अवलंबून राहू नका.",
            "Your message includes a potentially serious emergency symptom. Please seek urgent medical assessment now. If the symptom is severe, sudden, worsening, or you feel unsafe, contact your local emergency service or go to the nearest emergency department. Do not rely on this chatbot to determine the cause.":
                "तुमच्या संदेशात संभाव्यतः गंभीर आपत्कालीन लक्षण आहे. कृपया आत्ताच तातडीची वैद्यकीय तपासणी करून घ्या. लक्षण गंभीर, अचानक किंवा वाढत असल्यास किंवा तुम्हाला असुरक्षित वाटत असल्यास स्थानिक आपत्कालीन सेवेशी संपर्क करा किंवा जवळच्या आपत्कालीन विभागात जा. कारण निश्चित करण्यासाठी या चॅटबॉटवर अवलंबून राहू नका."
        },
        "hi": {
            "Okay, I understand you have": "ठीक है, आपको",
            "How long have you had the": "आपको यह",
            "For example, you can say": "उदाहरण के लिए, आप कह सकते हैं",
            "Do you also have headache, cough, chills, body pain, vomiting, or dizziness?":
                "क्या आपको सिरदर्द, खांसी, ठंड लगना, बदन दर्द, उल्टी या चक्कर भी हैं?",
            "Thanks. How would you describe the": "धन्यवाद। आपके",
            "severity: mild, moderate, or severe?":
                "की गंभीरता हल्की, मध्यम या तेज कैसी है?",
            "How severe is it? You can say mild, moderate, severe, or give a pain score from 0 to 10.":
                "यह कितना गंभीर है? आप हल्का, मध्यम, तेज कह सकते हैं या 0 से 10 तक दर्द का स्कोर बता सकते हैं।",
            "Thanks. Before I give general guidance, are you having difficulty breathing, severe chest pain, fainting, confusion, heavy bleeding, or another severe/emergency symptom?":
                "धन्यवाद। सामान्य जानकारी देने से पहले, क्या आपको सांस लेने में दिक्कत, तेज सीने में दर्द, बेहोशी, भ्रम, ज्यादा रक्तस्राव या कोई अन्य गंभीर/आपातकालीन लक्षण है?",
            "Please answer yes or no.": "कृपया हाँ या नहीं में उत्तर दें।",
            "Those symptoms can be signs of a medical emergency. Please seek urgent medical care now or contact your local emergency service. Do not rely on this chatbot for emergency care.":
                "ये लक्षण चिकित्सकीय आपातकाल के संकेत हो सकते हैं। कृपया तुरंत चिकित्सा सहायता लें या स्थानीय आपातकालीन सेवा से संपर्क करें। आपातकालीन उपचार के लिए इस चैटबॉट पर निर्भर न रहें।",
            "Your message includes a potentially serious emergency symptom. Please seek urgent medical assessment now. If the symptom is severe, sudden, worsening, or you feel unsafe, contact your local emergency service or go to the nearest emergency department. Do not rely on this chatbot to determine the cause.":
                "आपके संदेश में संभावित रूप से गंभीर आपातकालीन लक्षण है। कृपया अभी तुरंत चिकित्सा जांच करवाएं। यदि लक्षण गंभीर, अचानक या बढ़ रहे हैं, या आपको असुरक्षित महसूस हो रहा है, तो स्थानीय आपातकालीन सेवा से संपर्क करें या नजदीकी आपातकालीन विभाग में जाएं। कारण जानने के लिए इस चैटबॉट पर निर्भर न रहें।"
        }
    }

    result = answer
    phrases = translations.get(language, {})
    for source, target in sorted(phrases.items(), key=lambda x: len(x[0]), reverse=True):
    ...
    names = {
        ...
        "dizziness": "चक्कर",
        "vomiting": ("उलटी" if language == "mr" else "उल्टी"),
        "diarrhea": ("जुलाब" if language == "mr" else "दस्त"),
        "weakness": "कमजोरी"
    }
...
def translate_legacy_answer(answer, language):
    """Best-effort translation for legacy KB/ML answers.

    Conversation answers use explicit templates above. This fallback keeps
    ordinary KB/ML responses usable when the user asks a direct Marathi/Hindi
    question outside the conversation flow.
    """
    if not answer or language == "en":
        return answer
    ...
    phrases = {
        "mr": {
            "Here is some general information": "ही काही सामान्य माहिती आहे",
            "Here is some general medical information.": "ही काही सामान्य वैद्यकीय माहिती आहे.",
            "This information does not provide a diagnosis.": "ही माहिती निदान देत नाही.",
            "Important:": "महत्त्वाचे:",
            "seek urgent medical care": "तातडीने वैद्यकीय मदत घ्या",
            "If symptoms are severe": "लक्षणे गंभीर असल्यास",
            "worsening": "वाढत असल्यास",
            "persistent": "सतत राहिल्यास",
            "fever": "ताप",
            "headache": "डोकेदुखी",
            "cough": "खोकला",
            "cold": "सर्दी",
        ...
        "hi": {
            "Here is some general information": "यह कुछ सामान्य जानकारी है",
            "Here is some general medical information.": "यह कुछ सामान्य चिकित्सा जानकारी है।",
            "This information does not provide a diagnosis.": "यह जानकारी निदान प्रदान नहीं करती है।",
            "Important:": "महत्वपूर्ण:",
            "seek urgent medical care": "तुरंत चिकित्सा सहायता लें",
            "If symptoms are severe": "यदि लक्षण गंभीर हैं",
            "worsening": "बढ़ रहे हैं",
            "persistent": "लगातार बने रहें",
            "fever": "बुखार",
            "headache": "सिरदर्द",
            "cough": "खांसी",
            "cold": "जुकाम",
...
def conversation_text(language, kind, primary="", duration=""):
    """Return a complete conversation reply in the user's language."""
    primary_display = (primary or "symptom").replace("_", " ")

    if language == "mr":
        if kind == "start_duration":
            return (
                f"ठीक आहे, तुम्हाला {primary_display} आहे. "
                f"तुम्हाला {primary_display} किती दिवसांपासून आहे? "
                "उदाहरणार्थ, तुम्ही '2 दिवस' किंवा 'कालपासून' असे सांगू शकता."
            )
        if kind == "start_associated":
            return (
                f"ठीक आहे, तुम्हाला {primary_display} सुमारे {duration} पासून आहे. "
                "तुम्हाला डोकेदुखी, खोकला, थंडी वाजणे, अंगदुखी, उलटी किंवा चक्कर "
                "यापैकी काही आहे का?"
            )
        if kind == "duration_followup":
            return (
                f"तुम्हाला {primary_display} सुमारे {duration} पासून आहे, हे समजले. "
                "तुम्हाला डोकेदुखी, खोकला, थंडी वाजणे, अंगदुखी, उलटी किंवा चक्कर "
                "यापैकी काही आहे का?"
            )
        if kind == "ask_duration":
            return (
                f"तुम्हाला {primary_display} किती दिवसांपासून आहे? "
                "उदाहरणार्थ, तुम्ही '2 दिवस' किंवा 'कालपासून' असे सांगू शकता."
            )
        if kind == "ask_severity":
            return (
                f"धन्यवाद. तुमच्या {primary_display} ची तीव्रता कशी आहे — "
                "सौम्य, मध्यम की तीव्र?"
            )
        if kind == "severity_invalid":
            return (
                "ते किती तीव्र आहे? तुम्ही सौम्य, मध्यम, तीव्र असे सांगू शकता "
                "किंवा 0 ते 10 पैकी वेदना गुण सांगू शकता."
            )
        if kind == "safety":
            return (
                "धन्यवाद. सामान्य मार्गदर्शन देण्यापूर्वी, तुम्हाला श्वास घेण्यास "
                "त्रास, तीव्र छातीत दुखणे, बेशुद्ध पडणे, गोंधळ, जास्त रक्तस्राव "
                "किंवा इतर गंभीर/आपत्कालीन लक्षण आहे का?"
            )
        if kind == "yesno":
            return (
                "कृपया हो किंवा नाही असे उत्तर द्या. तुम्हाला श्वास घेण्यास त्रास, "
                "तीव्र छातीत दुखणे, बेशुद्ध पडणे, गोंधळ, जास्त रक्तस्राव किंवा "
                "इतर गंभीर/आपत्कालीन लक्षण आहे का?"
            )

    if language == "hi":
        if kind == "start_duration":
            return (
                f"ठीक है, आपको {primary_display} है। आपको {primary_display} "
                "कितने समय से है? उदाहरण के लिए, आप '2 दिन' या 'कल से' कह सकते हैं।"
            )
        if kind == "start_associated":
            return (
                f"ठीक है, आपको {primary_display} लगभग {duration} से है। "
                "क्या आपको सिरदर्द, खांसी, ठंड लगना, बदन दर्द, उल्टी या चक्कर भी हैं?"
            )
        if kind == "duration_followup":
            return (
                f"समझ गया। आपको {primary_display} लगभग {duration} से है। "
                "क्या आपको सिरदर्द, खांसी, ठंड लगना, बदन दर्द, उल्टी या चक्कर भी हैं?"
            )
        if kind == "ask_duration":
            return (
                f"आपको {primary_display} कितने समय से है? "
                "उदाहरण के लिए, आप '2 दिन' या 'कल से' कह सकते हैं।"
            )
        if kind == "ask_severity":
            return (
                f"धन्यवाद। आपके {primary_display} की गंभीरता कैसी है — "
                "हल्की, मध्यम या तेज?"
            )
        if kind == "severity_invalid":
            return (
                "यह कितना गंभीर है? आप हल्का, मध्यम, तेज कह सकते हैं "
                "या 0 से 10 तक दर्द का स्कोर बता सकते हैं।"
            )
        if kind == "safety":
            return (
                "धन्यवाद। सामान्य जानकारी देने से पहले, क्या आपको सांस लेने में "
                "दिक्कत, तेज सीने में दर्द, बेहोशी, भ्रम, ज्यादा रक्तस्राव या कोई "
                "अन्य गंभीर/आपातकालीन लक्षण है?"
            )
        if kind == "yesno":
            return (
                "कृपया हाँ या नहीं में उत्तर दें। क्या आपको सांस लेने में दिक्कत, "
                "तेज सीने में दर्द, बेहोशी, भ्रम, ज्यादा रक्तस्राव या कोई अन्य "
                "गंभीर/आपातकालीन लक्षण है?"
            )

    # English
    if kind == "start_duration":
        return (
            f"Okay, I understand you have {primary_display}. "
            f"How long have you had the {primary_display}? "
            "For example, you can say '2 days' or 'since yesterday'."
        )
    if kind == "start_associated":
        return (
            f"Okay, I understand you have {primary_display} and it has been "
            f"present for about {duration}. Do you also have headache, cough, "
            "chills, body pain, vomiting, or dizziness?"
        )
    if kind == "duration_followup":
        return (
            f"Got it. You have had {primary_display} for about {duration}. "
            "Do you also have headache, cough, chills, body pain, vomiting, or dizziness?"
        )
    if kind == "ask_duration":
        return (
    ...
    if kind == "ask_severity":
        return (
            f"Thanks. How would you describe the {primary_display} severity: "
            "mild, moderate, or severe?"
        )
    if kind == "severity_invalid":
        return (
            "How severe is it? You can say mild, moderate, severe, "
            "or give a pain score from 0 to 10."
        )
    if kind == "safety":
        return (
            "Thanks. Before I give general guidance, are you having difficulty "
            "breathing, severe chest pain, fainting, confusion, heavy bleeding, "
            "or another severe/emergency symptom?"
        )
    if kind == "yesno":
        return (
            "Please answer yes or no. Are you having difficulty breathing, severe "
            "chest pain, fainting, confusion, heavy bleeding, or another "
            "severe/emergency symptom?"
        )
    return ""


def emergency_response(language):
    if language == "mr":
        return (
            "तुमच्या संदेशात संभाव्यतः गंभीर आपत्कालीन लक्षण दिसत आहे. "
            "कृपया आत्ताच तातडीची वैद्यकीय तपासणी करून घ्या. लक्षण गंभीर, "
            "अचानक किंवा वाढत असल्यास किंवा तुम्हाला असुरक्षित वाटत असल्यास "
            "स्थानिक आपत्कालीन सेवेशी संपर्क करा किंवा जवळच्या आपत्कालीन "
            "विभागात जा. कारण निश्चित करण्यासाठी या चॅटबॉटवर अवलंबून राहू नका."
        )
    if language == "hi":
        return (
            "आपके संदेश में संभावित रूप से गंभीर आपातकालीन लक्षण है। "
            "कृपया अभी तुरंत चिकित्सा जांच करवाएं। यदि लक्षण गंभीर, अचानक "
            "या बढ़ रहे हैं, या आपको असुरक्षित महसूस हो रहा है, तो स्थानीय "
            "आपातकालीन सेवा से संपर्क करें या नजदीकी आपातकालीन विभाग में जाएं। "
            "कारण जानने के लिए इस चैटबॉट पर निर्भर न रहें।"
        )
    return (
        "Your message includes a potentially serious emergency symptom. "
        "Please seek urgent medical assessment now. If the symptom is severe, "
        "sudden, worsening, or you feel unsafe, contact your local emergency "
        "service or go to the nearest emergency department. Do not rely on "
        "this chatbot to determine the cause."
    )
...
def handle_conversation_turn(session_id, text, symptoms, duration,
    ...
    # Use the English-normalized representation for intent/symptom logic,
    # while keeping the original user text for display and chat history.
    ...
    if state:
        if language != state.get("language"):
            save_conversation_state(
                session_id,
                state.get("primary_symptom") or "symptom",
                state.get("duration"),
                state.get("associated_symptoms", []),
                state.get("severity"),
                state.get("step") or "duration",
                language
            )
        ...
        if step == "duration":
            if duration:
                ...
                return _conversation_response(
                    session_id,
                    text,
                    conversation_text(language, "duration_followup",
                                       primary, duration),
                    [],
                    confidence,
            ...
            return _conversation_response(
                session_id,
                text,
                conversation_text(language, "ask_duration", primary),
                [],
                confidence,
                "conversation_follow_up"
            )
        ...
        if step == "associated_symptoms":
            ...
            if query in {
                "no", "nope", "none", "no other symptoms",
            ...
            return _conversation_response(
                session_id,
                text,
                conversation_text(language, "ask_severity", primary),
                new_symptoms,
                confidence,
                "conversation_follow_up"
            )
        ...
        if step == "severity":
            ...
            if not severity:
                return _conversation_response(
                    session_id,
                    text,
                    conversation_text(language, "severity_invalid"),
                    [],
                    confidence,
                    "conversation_follow_up"
                )
            ...
            return _conversation_response(
                session_id,
                text,
                conversation_text(language, "safety"),
                [],
                confidence,
        ...
        if step == "red_flags":
            ...
            has_emergency = yes or any(
                phrase in query for phrase in emergency_phrases
            )
            ...
            if query not in {
                "no", "nope", "none", "not really"
            }:
                return _conversation_response(
                    session_id,
                    text,
                    conversation_text(language, "yesno"),
                    [],
                    confidence,
                    "conversation_safety_check"
                )
    ...
    if symptoms and final_intent == "symptom_assistance":
        ...
        save_conversation_state(
            ...
            duration,
            other_symptoms,
            extract_severity(analysis_text),
            step,
            language
        )
...
def predict():
    ...
    try:
        ...
        # ----------------------------------------------------
        # LANGUAGE + INTERNAL ANALYSIS TEXT
        # ----------------------------------------------------
        # The API preserves the original user message, but the ML
        # model and rule-based extractors work on English-normalized
        # text. This is what allows Marathi/Hindi input to enter the
        # same medical conversation engine as English input.
        detected_language = detect_language(text)
        analysis_text = translate_input_to_english(text)
        ...
        if emergency_detected:
            emergency_answer = emergency_response(
                detected_language
            )
        ...
        if not medical_query:
            ...
            return jsonify({
                ...
                "answer":
                    translate_legacy_answer(answer, detected_language),
